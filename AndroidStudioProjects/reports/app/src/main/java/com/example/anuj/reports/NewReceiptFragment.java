...
public class NewReceiptFragment extends Fragment {
    ...
    private ParseImageView receiptPreview;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        View v = inflater.inflate(R.layout.fragment_new_receipt, parent, false);

        Merchandise = ((EditText) v.findViewById(R.id.merchandise));
        ...
        photoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imm.hideSoftInputFromWindow(Merchandise.getWindowToken(), 0);
                startCamera();
            }
        });
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                ReceiptModel receiptModel = ((ReceiptCredentials) getActivity()).getCurrentReceipt();

                // When the user clicks "Save," upload the meal to Parse
                // Add data to the meal object:
                receiptModel.setMerchandise(Merchandise.getText().toString());
                receiptModel.setDate(Date.getText().toString());
                receiptModel.setPrice(Price.getText().toString());
                // Associate the meal with the current user


                // String ss = ParseUser.getCurrentUser().getObjectId();
                // adminModel.setObjectId(ss);
                ...
                receiptModel.saveInBackground(new SaveCallback() {
        ...
        receiptPreview = (ParseImageView) v.findViewById(R.id.receipt_preview_image);
        receiptPreview.setVisibility(View.INVISIBLE);
    ...
    public void startCamera() {
        ...
        transaction.addToBackStack("NewReceiptFragment");
        transaction.commit();
    }
    ...
    public void onResume() {
        super.onResume();
        ParseFile photoFile = ((ReceiptCredentials) getActivity())
                .getCurrentReceipt().getImageFile();
        if (photoFile != null) {
            receiptPreview.setParseFile(photoFile);
            receiptPreview.loadInBackground(new GetDataCallback() {
                @Override
